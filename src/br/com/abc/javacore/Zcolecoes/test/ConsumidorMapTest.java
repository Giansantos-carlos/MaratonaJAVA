...
public class ConsumidorMapTest {
    public static void main(String[] args) {
        Consumidor consumidor = new Consumidor("Gain SAntos", "122");
        Consumidor consumidor2 = new Consumidor("GForce Sys", "321");
        Consumidor consumidor3 = new Consumidor("Force Sys", "321");


        Produto produto1 = new Produto("123", "Laptop Lenovo", 2000.0);
        Produto produto2 = new Produto("321", "Picanha", 26.4);
        Produto produto3 = new Produto("879", "Teclado Razer", 1000.0);
        Produto produto4 = new Produto("012", "Samsung galaxy S23 512Gb", 3250.5);

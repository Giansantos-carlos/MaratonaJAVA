...
public class LambdaTest2 {
    public static void main(String[] args) {
        forEach(asList("Gian", "DevDojo", "facebook.com/devdojobr"), (String s) -> System.out.println(s));
        List<Integer> list = map(asList("Gian", "DevDojo", "facebook.com/devdojobr"), (String s) -> s.length());

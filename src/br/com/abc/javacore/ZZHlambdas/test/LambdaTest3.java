...
public class LambdaTest3 {
    public static void main(String[] args) {
        forEach(asList("Gian", "DevDojo", "facebook.com/devdojobr"), System.out::println);
        ...
        List<String> nomes = asList("Gian", "DevDojo", "Anna", "Brenon");
        ...
        System.out.println(contains2.test(nomes,"Gian"));
